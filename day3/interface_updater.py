...
def main():
    ...
    with Scrapli(host=device,port=HOST_NAP_MAP[device],transport="paramiko",auth_username="admin",auth_password="admin",auth_strict_key=False,platform=DC_DEVICE_PLATFORM_MAP[device]) as  conn:
